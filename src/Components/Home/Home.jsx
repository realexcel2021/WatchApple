    ...
    <div className='px-24 bg-substitute md:px-3' id='home'>
        <div className='pt-16 grid grid-cols-2 gap-7 items-center mb-12 sm:grid-cols-1'>
            ...
            <div className=' items-center'>
                ...
                <p className='text-gray-500 mt-5 text-xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor voluptate velit esse cillum dolore eu fugiat incididunt ullamco.</p>
                <button className='px-7 py-4 mt-6 bg-secondary text-primary text-xl rounded'>GET THE APP</button>
            </div>
